...
public sealed class CounterMeterSetTests
{
    ...
    [Theory]
    [InlineData("Service Fabric Transactional Replicator", "{0}:123", "partition_id,replica_id")]
    [InlineData("Service Fabric TStore", "{0}:123:456_789", "partition_id,replica_id,state_provider_id")]
    [InlineData("Service Fabric Service", "{0}_123_456", "partition_id,replica_id")]
    [InlineData("Service Fabric Service Method", "Method_Interface_{0}_123_456", "interface,method,partition_id,replica_id")]
    [InlineData("Service Fabric Actor", "{0}_456", "partition_id")]
    [InlineData("Service Fabric Actor Method", "Method_Interface_456", "interface,method")]

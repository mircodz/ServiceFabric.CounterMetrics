...
public static class ServiceFabricCounterMetrics
{
    ...
    /// dispose from OnCloseAsync/OnAbort. Actor counters are matched by partition
    /// because their instance names do not contain a replica id.
    /// </summary>
    ...
    /// <summary>
    /// Emit every instance on the node (agent/sidecar deployment).
    /// </summary>
